...
<div class="navbar">
	...
	<img src="https://i.imgur.com/JOkbszT.jpg" alt="logo2" style="margin-right:20%;" >
          ...
          <div class="col-md-3">
            ...
            <div class="checkbox">
              <label><input type="checkbox" name="filter" id="filter[]" class="icheck" value="Research"> Research </label>
						...
						<div class="checkbox">
							<label><input type="checkbox" name="filter2" id="filter2[]" class="icheck" value="2020"> 2020 </label>
						</div>
						<div class="checkbox">
