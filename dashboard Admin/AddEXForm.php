...
updateGP1EXform($Project1,$Project2,$Project3,$Project4,$Project5,$desc);
}
 ?>
   <div class="row">
     <div class="col-3"></div>
   ...
   <div>
     <form method="post" action="AddEXForm.php">
...
<form method="post" action="AddEXgp2Form.php">
      ...
      <input type="submit" class="btn btn-primary" name="submit2" value="Next" ><br>
